...
def sendmessage():
    ...
    if message_to_send=="y" or message_to_send=="Y":
        ...
        ftp_server=ftplib(host_name,user_name,password)
        ftp_server.enccoding("utf-8")
...
def browse_files():
    ...
    try:
        ...
        print("cancel the button prssed by you")
...
def openChatWindow():
    ...
    attach=Button(window,text="Attach & Send",bd=1, font = ("Calibri",10),command=browse_files)
